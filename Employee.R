...
write.csv(Emp,"/home/tejaswini/bdt/2.csv")

readStudent=read.csv("/home/tejaswini/bdt/2.csv")
print(readStudent)
...
write.table(x,"/home/tejaswini/bdt/2.csv",col.names = FALSE,  append = T,row.names = T, quote= FALSE, sep = ",")
readEmp = read.csv("/home/tejaswini/bdt/2.csv ")
print(readEmp)
